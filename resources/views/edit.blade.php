            ...
            <div class="card-body">
                <form method="POST" action="/updateprofile">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="text" placeholder="" class="form-control @error('name') is-invalid @enderror" name="title" value="{{ $video->id }}" required autocomplete="name" autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="email" type="text" placeholder="" class="form-control @error('email') is-invalid @enderror" name="route" value="" required autocomplete="email">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="password" type="text" class="form-control @error('password') is-invalid @enderror" name="description" required autocomplete="new-password">
